...
public class BrowseForms extends androidx.fragment.app.Fragment
{
    private ArrayList<FormClass> forms = new ArrayList<>();
    private String apiID;

    public BrowseForms() { super(R.layout.activity_browse); }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        if(forms.size() > 0) header.setText("Available forms:");
